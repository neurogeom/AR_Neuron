...
namespace net_csharp
{
    ...
    class Program
    {
        ...
        private static void AcceptCallback(IAsyncResult AR)
        {
            ...
            socket.BeginReceive(result, 0, 1024, SocketFlags.None, ReceiveCallback, socket);
        ...
        private static void ReceiveCallback(IAsyncResult AR)
        {
            ...
            HandleCommand(text, curIndex);

            current.BeginReceive(result, 0, 1024, SocketFlags.None, ReceiveCallback, current);
        }


        private static void HandleCommand(string text,int socketIndex)
        {
            ...
            switch (ca.commandType)
            {
                ...
                case CommandType.Connection_MobilePhone:
                    ...
                    Console.WriteLine("Transmitted Infomation: " + command);
                    break;
                ...
                case CommandType.FileSelection:
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Transmitted Infomation: " + swcContent);
                    }
                    break;
